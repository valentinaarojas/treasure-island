...
print("Since the very beginning of the Age of Exploration, explorers from around the world have set out to seas "
      "in the attempt to discover the location of the hidden treasure ")
