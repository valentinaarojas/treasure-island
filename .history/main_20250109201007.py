...
if firstChoice == "left":
    ...
    if secondChoice == "fight":
        ...
        print("Its ancient stone walls are covered in thick vines and strange glowing symbols that pulse with an otherworldly blue light. The massive doorway seems to beckon you forward, but as you approach, you notice something odd - there's no door, just a shimmering barrier of energy that ripples like water.
Through the translucent barrier, you can make out what appears to be a golden idol sitting atop a pedestal.")
