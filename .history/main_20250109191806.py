...
firstChoice = input("As you embark on your journey and go deeper into the jungle, you come across a crossroads.\n"
                    "The left path is one of which many explorers have previously followed,while the right" 
