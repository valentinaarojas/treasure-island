...
print("Since the dawn of the Age of Exploration, explorers from around the world have set out to seas\n"
      "in an attempt to discover the hidden treasure located in the heart of the jungle of Treasure Island.\n"
      "Christopher Columbus, Ferdinand Magellan, and even Marco Polo have all attempted to discover\n"
      "the treasure, but none have prevailed")
