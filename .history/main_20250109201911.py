...
if firstChoice == "left":
    ...
    if secondChoice == "fight":
        ...
        print("Its ancient stone walls are covered in thick vines and strange glowing symbols that pulse with an otherworldly blue light.\n"
              ...
              "shimmering barrier of energy that ripples like water. Through the translucent barrier, you can make out what appears to be\n" 
              "a golden idol sitting atop a pedestal." 
              "\nWould you like to try to walk through the barrier, look for another way in, or throw a rock at the barrier to test it?")
        ...
        if thirdChoice == "walk":
            ...
            print("\nThe rock passes through the barrier and hits the gem in the idol's hands. The barrier dissipates! You walk in and claim your prize - the ancient Gem of the Jungle Kings. You've completed your quest! YOU WIN!")
