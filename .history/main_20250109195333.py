...
if firstChoice == "left":
    ...
    if secondChoice == "fight":
        ...
        print("You slowly reach for your trusty hunting knife you always carry with you as you stare down the baboon.\n"
              "You charge towards the baboon and it charges towards you, until you meet in the middle and start wr")
        ...
        print("You freeze up in front of the baboon and it mauls you before you could think to do anything reasonable. Game over.\n")
        exit()
