...
if firstChoice == "left":
    ...
    if secondChoice == "fight":
        ...
        print("You slowly reach for your trusty hunting knife you always carry with you as you stare down the rabid baboon")
        ...
        print("\nAs you take off running, the rabid baboon charges after you. Right when you think " 
