...
if firstChoice == "left":
    ...
    if secondChoice == "fight":
        ...
        print("Its ancient stone walls are covered in thick vines and strange glowing symbols that pulse with an otherworldly blue light.\n"
              ...
              "a golden idol sitting atop a pedestal. Would you like to try to walk through the barrier, look for another way in, or throw a rock at the barrier to test it?")
