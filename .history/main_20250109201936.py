...
if firstChoice == "left":
    ...
    if secondChoice == "fight":
        ...
        if thirdChoice == "walk":
            ...
            print("\nThe rock passes through the barrier and topple over the golden idol. The barrier dissipates! You walk in and claim your prize - the ancient Gem of the Jungle Kings. You've completed your quest! YOU WIN!")
